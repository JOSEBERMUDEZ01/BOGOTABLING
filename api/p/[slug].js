...
export default async function handler(req, res) {
  ...
  const SITE_URL = "https://bogotabling.vercel.app";
  ...
  const title = `${product.name} — Bogotá Bling`;
  const description = `${priceText} · Relojería y joyería de lujo en Bogotá, Colombia. Escríbenos por WhatsApp.`;
  const image =
...
<meta property="og:site_name" content="Bogotá Bling"/>
