...
export default async function handler(req, res) {
  ...
  try {
    const r = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Bogotá Bling <onboarding@resend.dev>',
        to: [to],
        subject: `Bogotá Bling — ${title}`,
        html: `
          <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;color:#111">
            ...
            <p style="color:#555;font-size:14px">${when} (hora de Bogotá)</p>
            <p style="font-size:14px;line-height:1.6">
              Te avisamos porque se hizo un cambio en tu cuenta del panel administrativo de Bogotá Bling.
            </p>
